...
function Shejifei({ subjects }) {
  const [activeTab, setActiveTab] = useState('generate');
  const [contractNo, setContractNo] = useState('');
  const [status, setStatus] = useState('');

  const metrics = [
    { label: '本期应核算项目', value: 100, suffix: '个' },
    { label: '设计费项目确认', value: 80, rate: '80.0%' }
  ];

  const generateData = [
    { org: '成都分公司', id: 'SJ901000001', calcStatus: '已计算', calcTime: '2026-03-01 18:00:00', confirmStatus: '已确认', confirmTime: '2026-03-01 20:00:00', done: true },
  ];

  const syncData = [
    { org: '成都分公司', id: 'SJ901000001', srcDoc: '设计费项目核算单', srcDocNo: 'SJ901000001-20260301', targetNode: '项目核算收入确认', targetDoc: '应收单', targetDocNo: 'AR20260200', targetTime: '2026-03-01 11:00:00', ebsStatus: '已同步', ebsTime: '2026-03-01 11:00:00', kdStatus: '未同步', kdTime: '2026-03-01 18:00:00' }
  ];
  ...
  return (
    <div className="space-y-6" data-ai-alt="设计费核算区域">
      <div className="bg-[#f8faff] p-4 rounded border border-[#e0e8f5]" data-ai-alt="设计费指标概览">
        <h3 className="text-[14px] font-bold text-[#003366] mb-4">设计费核算进度概览</h3>
        ...
        <div className="flex flex-col space-y-2">
          ...
          <div className="h-[8px] bg-[#e8e8e8] rounded-full overflow-hidden w-[416px]">
            <div className="bg-[#0055ff] h-full" style={{ width: '80%' }}></div>
          </div>
        </div>
      </div>

      <div className="bg-[#f8faff] p-4 rounded border border-[#e0e8f5]">
        <h3 className="text-[14px] font-bold text-[#003366] mb-4">设计费核算步骤</h3>
              ...
              <table className="w-full text-left border-collapse text-[12px]">
                <thead>
                  <tr className="bg-[#f0f2f5] text-[#333]">
                    ...
                    <th className="p-2 border border-[#e8e8e8]">计算状态</th>
                    <th className="p-2 border border-[#e8e8e8]">计算时间</th>
                    <th className="p-2 border border-[#e8e8e8]">确认状态</th>
                    <th className="p-2 border border-[#e8e8e8]">确认时间</th>
